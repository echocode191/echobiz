// /workspaces/echobiz/src/pages/EbooksPage.jsx
...
const EbooksPage = () => {
  ...
  return (
    <div style={sectionStyle}>
      <h1 style={headingStyle}>eBooks</h1>
      ...
      <div style={gridStyle}>
        {ebooks.map(book => (
          ...
          >
            ...
            <p style={descriptionStyle} title={book.description}>{book.description}</p>
            <p style={contentStyle} title={book.content}>{book.content}</p>
            ...
            <div style={metaStyle}>
              <span style={categoryStyle} title={book.category}>{book.category}</span>
        ...
        <div style={fullViewOverlayStyle} onClick={closeFullView}>
          <div style={fullViewContentStyle} onClick={(e) => e.stopPropagation()}>
            ...
            <div style={{ display: 'flex', marginBottom: '1.5rem', flexDirection: 'column', alignItems: 'center' }}>
              ...
              <div style={{ textAlign: 'center' }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', marginBottom: '1rem' }}>
                  ...
                  <span style={{...pagesStyle, backgroundColor: '#f3f4f6', padding: '0.25rem 0.75rem', borderRadius: '9999px', fontSize: '0.875rem'}}>{fullViewItem.pages} pages</span>
            ...
            <div style={{ backgroundColor: '#f9fafb', padding: '1rem', borderRadius: '0.5rem', borderLeft: '4px solid #4F46E5' }}>
              <h3 style={{ fontSize: '1.25rem', marginBottom: '1rem', color: '#1F2937' }}>eBook Details</h3>
